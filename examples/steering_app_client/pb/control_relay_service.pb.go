...
type ControlRelayPacket struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	DeviceName      string `protobuf:"bytes,1,opt,name=device_name,json=deviceName,proto3" json:"device_name,omitempty"`
	DeviceInterface string `protobuf:"bytes,2,opt,name=device_interface,json=deviceInterface,proto3" json:"device_interface,omitempty"`
	OriginatingRule string `protobuf:"bytes,3,opt,name=originating_rule,json=originatingRule,proto3" json:"originating_rule,omitempty"`
	Packet          []byte `protobuf:"bytes,10,opt,name=packet,proto3" json:"packet,omitempty"`
}

func (x *ControlRelayPacket) Reset() {
	*x = ControlRelayPacket{}
	if protoimpl.UnsafeEnabled {
		mi := &file_control_relay_service_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *ControlRelayPacket) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ControlRelayPacket) ProtoMessage() {}

func (x *ControlRelayPacket) ProtoReflect() protoreflect.Message {
	mi := &file_control_relay_service_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ControlRelayPacket.ProtoReflect.Descriptor instead.
func (*ControlRelayPacket) Descriptor() ([]byte, []int) {
	return file_control_relay_service_proto_rawDescGZIP(), []int{4}
}

func (x *ControlRelayPacket) GetDeviceName() string {
	if x != nil {
		return x.DeviceName
	}
	return ""
...
func (x *ControlRelayPacket) GetDeviceInterface() string {
	if x != nil {
...
func (x *ControlRelayPacket) GetOriginatingRule() string {
	if x != nil {
...
func (x *ControlRelayPacket) GetPacket() []byte {
	if x != nil {
		return x.Packet
	}
	return nil
...
var file_control_relay_service_proto_rawDesc = []byte{
	...
	0x74, 0x5f, 0x68, 0x65, 0x6c, 0x6c, 0x6f, 0x22, 0xa3, 0x01, 0x0a, 0x12, 0x43, 0x6f, 0x6e, 0x74,
	0x72, 0x6f, 0x6c, 0x52, 0x65, 0x6c, 0x61, 0x79, 0x50, 0x61, 0x63, 0x6b, 0x65, 0x74, 0x12, 0x1f,
	...
	,
}
...
var file_control_relay_service_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_control_relay_service_proto_goTypes = []interface{}{
	...
	(*ControlRelayPacket)(nil), // 4: control_relay_service.v1.ControlRelayPacket
...
var file_control_relay_service_proto_depIdxs = []int32{
	...
	4, // 5: control_relay_service.v1.ControlRelayPacketService.PacketTx:input_type -> control_relay_service.v1.ControlRelayPacket
	5, // 6: control_relay_service.v1.ControlRelayPacketService.ListenForPacketRx:input_type -> google.protobuf.Empty
	3, // 7: control_relay_service.v1.ControlRelayHelloService.Hello:output_type -> control_relay_service.v1.HelloResponse
	5, // 8: control_relay_service.v1.ControlRelayPacketService.PacketTx:output_type -> google.protobuf.Empty
	4, // 9: control_relay_service.v1.ControlRelayPacketService.ListenForPacketRx:output_type -> control_relay_service.v1.ControlRelayPacket
...
func file_control_relay_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_control_relay_service_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ControlRelayPacket); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
...
// ControlRelayPacketServiceClient is the client API for ControlRelayPacketService service.
//
// For semantics around ctx use and closing/ending streaming RPCs, please refer to https://godoc.org/google.golang.org/grpc#ClientConn.NewStream.
type ControlRelayPacketServiceClient interface {
	PacketTx(ctx context.Context, in *ControlRelayPacket, opts ...grpc.CallOption) (*empty.Empty, error)
	ListenForPacketRx(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (ControlRelayPacketService_ListenForPacketRxClient, error)
}

type controlRelayPacketServiceClient struct {
	cc grpc.ClientConnInterface
}

func NewControlRelayPacketServiceClient(cc grpc.ClientConnInterface) ControlRelayPacketServiceClient {
	return &controlRelayPacketServiceClient{cc}
}

func (c *controlRelayPacketServiceClient) PacketTx(ctx context.Context, in *ControlRelayPacket, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
	err := c.cc.Invoke(ctx, "/control_relay_service.v1.ControlRelayPacketService/PacketTx", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *controlRelayPacketServiceClient) ListenForPacketRx(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (ControlRelayPacketService_ListenForPacketRxClient, error) {
	stream, err := c.cc.NewStream(ctx, &_ControlRelayPacketService_serviceDesc.Streams[0], "/control_relay_service.v1.ControlRelayPacketService/ListenForPacketRx", opts...)
	if err != nil {
		return nil, err
	}
	x := &controlRelayPacketServiceListenForPacketRxClient{stream}
...
type ControlRelayPacketService_ListenForPacketRxClient interface {
	Recv() (*ControlRelayPacket, error)
	grpc.ClientStream
}

type controlRelayPacketServiceListenForPacketRxClient struct {
	grpc.ClientStream
}

func (x *controlRelayPacketServiceListenForPacketRxClient) Recv() (*ControlRelayPacket, error) {
	m := new(ControlRelayPacket)
...
// ControlRelayPacketServiceServer is the server API for ControlRelayPacketService service.
type ControlRelayPacketServiceServer interface {
	PacketTx(context.Context, *ControlRelayPacket) (*empty.Empty, error)
	ListenForPacketRx(*empty.Empty, ControlRelayPacketService_ListenForPacketRxServer) error
}

// UnimplementedControlRelayPacketServiceServer can be embedded to have forward compatible implementations.
type UnimplementedControlRelayPacketServiceServer struct {
}

func (*UnimplementedControlRelayPacketServiceServer) PacketTx(context.Context, *ControlRelayPacket) (*empty.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method PacketTx not implemented")
}
func (*UnimplementedControlRelayPacketServiceServer) ListenForPacketRx(*empty.Empty, ControlRelayPacketService_ListenForPacketRxServer) error {
	return status.Errorf(codes.Unimplemented, "method ListenForPacketRx not implemented")
}

func RegisterControlRelayPacketServiceServer(s *grpc.Server, srv ControlRelayPacketServiceServer) {
	s.RegisterService(&_ControlRelayPacketService_serviceDesc, srv)
}

func _ControlRelayPacketService_PacketTx_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ControlRelayPacket)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ControlRelayPacketServiceServer).PacketTx(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/control_relay_service.v1.ControlRelayPacketService/PacketTx",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ControlRelayPacketServiceServer).PacketTx(ctx, req.(*ControlRelayPacket))
	}
	return interceptor(ctx, in, info, handler)
}

func _ControlRelayPacketService_ListenForPacketRx_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(empty.Empty)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(ControlRelayPacketServiceServer).ListenForPacketRx(m, &controlRelayPacketServiceListenForPacketRxServer{stream})
}

type ControlRelayPacketService_ListenForPacketRxServer interface {
	Send(*ControlRelayPacket) error
	grpc.ServerStream
}

type controlRelayPacketServiceListenForPacketRxServer struct {
	grpc.ServerStream
}

func (x *controlRelayPacketServiceListenForPacketRxServer) Send(m *ControlRelayPacket) error {
	return x.ServerStream.SendMsg(m)
}

var _ControlRelayPacketService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "control_relay_service.v1.ControlRelayPacketService",
	HandlerType: (*ControlRelayPacketServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "PacketTx",
			Handler:    _ControlRelayPacketService_PacketTx_Handler,
		},
	},
	Streams: []grpc.StreamDesc{
		{
			StreamName:    "ListenForPacketRx",
			Handler:       _ControlRelayPacketService_ListenForPacketRx_Handler,
			ServerStreams: true,
		},
	},
	Metadata: "control_relay_service.proto",
